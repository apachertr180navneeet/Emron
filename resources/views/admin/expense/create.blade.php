...
<div class="data-card">
    <div class="d-flex align-items-center gap-3 px-4 py-3 border-bottom">
        ...
        <h5 class="card-section-title mb-0"><i class="bi bi-cash-coin"></i> Add Expense</h5>
    </div>
    <div class="p-4">
        <form action="{{ route('admin.expense.store') }}" method="POST">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="expense_name" class="form-control @error('expense_name') is-invalid @enderror" placeholder="e.g. Travel, Office Supplies" value="{{ old('expense_name') }}">
                    @error('expense_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6">
                    <label class="form-label">Description</label>
                    <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Optional description" value="{{ old('description') }}">
            ...
            <div class="mt-4 pt-3 border-top d-flex gap-2 justify-content-end">
                ...
                <button type="submit" class="btn btn-primary px-4" style="border-radius:.75rem;font-weight:600">Save Expense</button>
            </div>
        </form>
    </div>
</div>
