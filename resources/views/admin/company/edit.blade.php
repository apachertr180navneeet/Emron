...
<div class="data-card">
    <div class="d-flex align-items-center gap-3 px-4 py-3 border-bottom">
        ...
        <h5 class="card-section-title mb-0"><i class="bi bi-pencil"></i> Edit Company</h5>
    </div>
    <div class="p-4">
        <form action="{{ route('admin.company.update', $company->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="gst_number" class="form-control @error('gst_number') is-invalid @enderror" placeholder="Enter GST number" value="{{ old('gst_number', $company->gst_number) }}">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="2" placeholder="Enter address">{{ old('address', $company->address) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="state" class="form-control @error('state') is-invalid @enderror" placeholder="Enter state" value="{{ old('state', $company->state) }}">
                        @error('state')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Pin Code</label>
                        <input type="text" name="pin_code" class="form-control @error('pin_code') is-invalid @enderror" placeholder="Enter pin code" value="{{ old('pin_code', $company->pin_code) }}">
                    ...
                    <div class="mb-3">
                        ...
                        @if($company->logo)
                            <div class="mt-2">
                                <img src="{{ asset($company->logo) }}" style="height:48px;border-radius:.5rem;border:1px solid #e2e8f0">
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" placeholder="Username" value="{{ old('username', $company->username) }}">
            ...
            <div class="mt-4 pt-3 border-top d-flex gap-2 justify-content-end">
                ...
                <button type="submit" class="btn btn-primary px-4" style="border-radius:.75rem;font-weight:600">Update Company</button>
            </div>
        </form>
    </div>
</div>
