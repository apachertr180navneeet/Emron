...
@section('page_title', 'Add Salesman')
@section('content')
<div class="data-card">
    <div class="d-flex align-items-center gap-3 px-4 py-3 border-bottom">
        ...
        <h5 class="card-section-title mb-0"><i class="bi bi-person-badge"></i> Add Salesman</h5>
    </div>
    <div class="p-4">
        <form action="{{ route('admin.salesman.store') }}" method="POST">
            @csrf
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-4">
                    ...
                    <input type="text" name="salesman_name" class="form-control @error('salesman_name') is-invalid @enderror" placeholder="Enter salesman name" value="{{ old('salesman_name') }}">
            ...
            <div class="mt-4 pt-3 border-top d-flex gap-2 justify-content-end">
                ...
                <button type="submit" class="btn btn-primary px-4" style="border-radius:.75rem;font-weight:600">Save Salesman</button>
            </div>
        </form>
    </div>
</div>
