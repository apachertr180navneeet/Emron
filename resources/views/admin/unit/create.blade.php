        ...
        <form action="{{ route('admin.unit.store') }}" method="POST">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="sub_unit" class="form-control @error('sub_unit') is-invalid @enderror" placeholder="e.g. gm, ml, mm" value="{{ old('sub_unit') }}">
                    @error('sub_unit')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3">
                    <label class="form-label">Subunit Value</label>
                    <input type="number" name="subunit_value" class="form-control @error('subunit_value') is-invalid @enderror" placeholder="e.g. 1000" value="{{ old('subunit_value') }}" step="any">
