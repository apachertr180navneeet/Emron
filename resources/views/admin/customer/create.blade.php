...
<div class="data-card">
    <div class="d-flex align-items-center gap-3 px-4 py-3 border-bottom">
        ...
        <h5 class="card-section-title mb-0"><i class="bi bi-people"></i> Add Customer</h5>
    </div>
    <div class="p-4">
        <form action="{{ route('admin.customer.store') }}" method="POST">
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="mobile" class="form-control @error('mobile') is-invalid @enderror" placeholder="Enter mobile number" value="{{ old('mobile') }}" maxlength="10">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="location" class="form-control @error('location') is-invalid @enderror" placeholder="Enter city / location" value="{{ old('location') }}">
                    @error('location')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4">
                    <label class="form-label">Firm Name</label>
                    <input type="text" name="firm_name" class="form-control @error('firm_name') is-invalid @enderror" placeholder="Enter firm / business name" value="{{ old('firm_name') }}">
            ...
            <div class="mt-4 pt-3 border-top d-flex gap-2 justify-content-end">
                ...
                <button type="submit" class="btn btn-primary px-4" style="border-radius:.75rem;font-weight:600">Save Customer</button>
            </div>
        </form>
    </div>
</div>
