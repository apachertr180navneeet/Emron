        ...
        <form action="{{ route('admin.vendor.store') }}" method="POST">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="vendor_name" class="form-control @error('vendor_name') is-invalid @enderror" placeholder="Enter vendor contact name" value="{{ old('vendor_name') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="firm_name" class="form-control @error('firm_name') is-invalid @enderror" placeholder="Enter business / firm name" value="{{ old('firm_name') }}">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-4">
                    ...
                    <input type="text" name="mobile" class="form-control @error('mobile') is-invalid @enderror" placeholder="Enter contact number" value="{{ old('mobile') }}" maxlength="10">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="2" placeholder="Enter street address, building, suite...">{{ old('address') }}</textarea>
